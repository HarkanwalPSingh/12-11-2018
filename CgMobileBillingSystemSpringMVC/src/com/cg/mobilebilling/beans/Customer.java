...
public class Customer {
	@Id
	@SequenceGenerator(initialValue = 1001, name = "customer_seq", sequenceName = "custome_seq", allocationSize = 1)
	...
	public void setPostpaidAccounts(HashMap<Long, PostpaidAccount> postpaidAccounts) {
